        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Indications = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ...
                    DosageInstructions = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Doctor_Gender", "Gender IN ('Male', 'Female', 'Other')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Bill_Status", "Status IN ('Pending', 'Paid', 'Overdue', 'Cancelled')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImagingResults = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    VitalSigns = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Prescription_Status", "Status IN ('Active', 'Dispensed', 'Expired', 'Cancelled')");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Departments",
                columns: new[] { "Id", "CreatedAt", "Description", "HeadOfDepartment", "IsActive", "IsDeleted", "Location", "Name", "PhoneNumber", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 9, 15, 10, 56, 42, 193, DateTimeKind.Utc).AddTicks(2140), "Heart and cardiovascular diseases", "Dr. Ahmed Hassan", true, false, "Floor 2, Building A", "Cardiology", "1234567890", null },
                    { 2, new DateTime(2025, 9, 15, 10, 56, 42, 193, DateTimeKind.Utc).AddTicks(2144), "Brain and nervous system disorders", "Dr. Sarah Mohamed", true, false, "Floor 3, Building A", "Neurology", "1234567891", null },
                    { 3, new DateTime(2025, 9, 15, 10, 56, 42, 193, DateTimeKind.Utc).AddTicks(2147), "Bone, joint, and muscle disorders", "Dr. Omar Ali", true, false, "Floor 1, Building B", "Orthopedics", "1234567892", null },
                    { 4, new DateTime(2025, 9, 15, 10, 56, 42, 193, DateTimeKind.Utc).AddTicks(2149), "Medical care for infants, children, and adolescents", "Dr. Fatima Ahmed", true, false, "Floor 2, Building B", "Pediatrics", "1234567893", null },
                    { 5, new DateTime(2025, 9, 15, 10, 56, 42, 193, DateTimeKind.Utc).AddTicks(2152), "Emergency medical care", "Dr. Khalid Ibrahim", true, false, "Ground Floor, Building A", "Emergency", "1234567894", null }
                });

            migrationBuilder.InsertData(
                table: "Medicines",
                columns: new[] { "Id", "BatchNumber", "Contraindications", "CreatedAt", "Description", "DosageForm", "DosageInstructions", "ExpiryDate", "GenericName", "Indications", "IsActive", "IsDeleted", "Manufacturer", "MinimumStockLevel", "Name", "Price", "RequiresPrescription", "SideEffects", "StockQuantity", "Strength", "Unit", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, "PC2024001", "Liver disease, alcohol use", new DateTime(2025, 9, 15, 10, 56, 42, 193, DateTimeKind.Utc).AddTicks(2419), "Pain reliever and fever reducer", "Tablet", "1-2 tablets every 4-6 hours", new DateTime(2027, 9, 15, 10, 56, 42, 193, DateTimeKind.Utc).AddTicks(2409), "Acetaminophen", "Headache, fever, muscle pain", true, false, "PharmaCorp", 100, "Paracetamol", 5.00m, false, "Nausea, rash", 1000, "500mg", "tablet", null },
                    { 2, "MC2024001", "Penicillin allergy", new DateTime(2025, 9, 15, 10, 56, 42, 193, DateTimeKind.Utc).AddTicks(2427), "Antibiotic for bacterial infections", "Capsule", "1 capsule every 8 hours for 7 days", new DateTime(2027, 9, 15, 10, 56, 42, 193, DateTimeKind.Utc).AddTicks(2425), "Amoxicillin", "Respiratory infections, skin infections", true, false, "MediCorp", 50, "Amoxicillin", 15.00m, true, "Diarrhea, nausea, rash", 500, "250mg", "capsule", null }
                });

            migrationBuilder.InsertData(
                table: "Rooms",
                columns: new[] { "Id", "Building", "Capacity", "CreatedAt", "DepartmentId", "Description", "Floor", "HourlyRate", "IsActive", "IsAvailable", "IsDeleted", "RoomNumber", "RoomType", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, "Building A", 1, new DateTime(2025, 9, 15, 10, 56, 42, 193, DateTimeKind.Utc).AddTicks(2352), 1, "Cardiology consultation room", "Floor 2", 100m, true, true, false, "C101", "Consultation", null },
                    { 2, "Building A", 1, new DateTime(2025, 9, 15, 10, 56, 42, 193, DateTimeKind.Utc).AddTicks(2357), 2, "Neurology consultation room", "Floor 3", 120m, true, true, false, "N201", "Consultation", null },
                    { 3, "Building B", 1, new DateTime(2025, 9, 15, 10, 56, 42, 193, DateTimeKind.Utc).AddTicks(2361), 3, "Orthopedics consultation room", "Floor 1", 110m, true, true, false, "O101", "Consultation", null },
                    { 4, "Building B", 1, new DateTime(2025, 9, 15, 10, 56, 42, 193, DateTimeKind.Utc).AddTicks(2364), 4, "Pediatrics consultation room", "Floor 2", 90m, true, true, false, "P201", "Consultation", null },
                    { 5, "Building A", 4, new DateTime(2025, 9, 15, 10, 56, 42, 193, DateTimeKind.Utc).AddTicks(2368), 5, "Emergency room", "Ground Floor", 200m, true, true, false, "E001", "Emergency", null }
                });
